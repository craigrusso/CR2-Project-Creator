#!/bin/bash
# Script to build the Echelon app for Apple Silicon (ARM64) with minimal dependencies
# Exit on error
set -e
...
pyinstaller --clean echelon_arm64.spec
