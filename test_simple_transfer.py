#!/usr/bin/env python3
"""
Simple test to isolate the transfer crash issue
"""
...
def test_simple_transfer():
    """Test basic transfer functionality without UI"""
    print("Testing simple transfer functionality...")
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Test the Python copy engine without a sink
            engine = PythonCopyEngine(sink=None)  # No sink to avoid UI issues
            ...
            print("\n✓ All tests passed! The transfer functionality works without UI.")
            return True
