...
from PyQt6.QtGui import QFont, QColor, QIcon, QDrag, QBrush, QKeySequence, QPixmap, QPainter, QPen
...
class EnhancedStructureEditor(QDialog):
    ...
    def _handle_key_press(self, event):
        ...
        if event.key() == Qt.Key_A and event.modifiers() & Qt.KeyboardModifier.ControlModifier: # Changed from elif to if
        ...
        elif event.key() == Qt.Key_C and event.modifiers() & Qt.KeyboardModifier.ControlModifier and have_file_ops and not event.isAccepted():
        ...
        elif event.key() == Qt.Key_V and event.modifiers() & Qt.KeyboardModifier.ControlModifier and have_file_ops and not event.isAccepted():
            selected = self.tree_widget.selectedItems()
