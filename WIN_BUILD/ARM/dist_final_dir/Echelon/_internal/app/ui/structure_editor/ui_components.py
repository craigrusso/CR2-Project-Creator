...
from PyQt6.QtGui import QFont, QIcon, QColor, QPalette, QPainter, QDrag, QDropEvent, QPixmap, QCursor, QStandardItemModel, QStandardItem
...
class StructureEditorTree(QTreeWidget):
    ...
    def paintEvent(self, event):
        ...
        if self.invisibleRootItem().childCount() == 0 and self.placeholder_text:
            ...
            painter.drawText(rect, Qt.AlignmentFlagFlagFlag.AlignCenter, self.placeholder_text)
...
class UIBuilder(QObject):
    ...
    def init_ui(self):
        ...
        form_layout.setLabelAlignment(Qt.AlignmentFlagFlagFlag.AlignRight | Qt.AlignmentFlagFlagFlag.AlignVCenter)
        form_layout.setFormAlignment(Qt.AlignmentFlagFlagFlag.AlignLeft | Qt.AlignmentFlagFlagFlag.AlignTop)
        ...
        try:
            ...
            if item:
                ...
                if not item.childCount(): # It's a file (no children)
                    ...
                    if item.data(0, Qt.ItemDataRole.UserRole) and 'uses_project_name' in item.data(0, Qt.ItemDataRole.UserRole):
                        use_project_name.setChecked(item.data(0, Qt.ItemDataRole.UserRole)['uses_project_name'])
