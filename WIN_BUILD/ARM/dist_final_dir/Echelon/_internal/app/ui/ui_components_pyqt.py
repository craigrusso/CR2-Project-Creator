...
from PyQt6.QtGui import QFont, QCursor, QIcon, QColor, QPalette, QDragEnterEvent, QDropEvent, QPixmap, QPainter, QPen, QFontMetrics, QStandardItemModel, QStandardItem, QDesktopServices
...
class TemplateFileCard(QFrame):
    ...
    def __init__(self, parent, template_path, select_callback=None, remove_callback=None):
        ...
        try:
            ...
            self.template_label.setAlignment(Qt.AlignmentFlagFlagFlag.AlignCenter)
            ...
            self.path_label.setAlignment(Qt.AlignmentFlagFlagFlag.AlignCenter)
            ...
            if remove_callback:
                ...
                self.grid.addWidget(self.remove_btn, 0, 0, 1, 1, Qt.AlignmentFlagFlagFlag.AlignRight | Qt.AlignmentFlagFlagFlag.AlignTop)
...
class TemplateFolderCard(QFrame):
    ...
    def __init__(self, parent=None, folder_name="", app=None):
        ...
        self.title.setAlignment(Qt.AlignmentFlagFlagFlag.AlignCenter)
        self.title.setStyleSheet("color: white;")
        
        # Folder label
        self.folder_label = QLabel("Folder")
        self.folder_label.setFont(QFont(UI_FONT, 9))
        self.folder_label.setAlignment(Qt.AlignmentFlagFlagFlag.AlignCenter)
