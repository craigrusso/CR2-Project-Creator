...
from PyQt6.QtWidgets import QFrame, QLabel, QLineEdit, QVBoxLayout, QHBoxLayout, QMessageBox, QMenu, QAction, QWidget, QApplication, QStyle
...
class TemplateFolderCard(QFrame):
    ...
    def __init__(self, parent=None, folder_name="", app=None):
        ...
        self.layout.addWidget(self.icon_label, 0, Qt.AlignmentFlagFlagFlag.AlignCenter)  # Force center alignment
        ...
        self.rename_edit.setAlignment(Qt.AlignmentFlagFlagFlag.AlignCenter)
        ...
        self.layout.addWidget(self.name_container, 0, Qt.AlignmentFlagFlagFlag.AlignCenter)  # Force center alignment
