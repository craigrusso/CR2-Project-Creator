...
from PyQt6.QtGui import QIcon, QFont, QPalette, QColor, QPainter, QPen, QBrush, QPixmap, QDesktopServices, QCursor, QDragEnterEvent, QDropEvent, QFontMetrics, QStandardItemModel, QStandardItem
...
class ProjectCreatorApp(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.output_dir_label.setAlignment(Qt.AlignmentFlagFlagFlag.AlignRight | Qt.AlignmentFlagFlagFlag.AlignVCenter)
