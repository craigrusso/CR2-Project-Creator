...
def show_about(app):
    ...
    title_label.setAlignment(Qt.AlignmentFlagFlagFlag.AlignCenter)
    ...
    version_label.setAlignment(Qt.AlignmentFlagFlagFlag.AlignCenter)
    version_label.setStyleSheet(f"color: {colors['text']};")
    layout.addWidget(version_label)
    
    # Copyright info
    copyright_label = QLabel("© 2023-present Craig P. Russo and CR2 Creative")
    copyright_label.setAlignment(Qt.AlignmentFlagFlagFlag.AlignCenter)
    ...
    description.setAlignment(Qt.AlignmentFlagFlagFlag.AlignCenter)
...
"""
    ...
    for tab_name, tutorial_text in tabs.items():
        ...
        content.setAlignment(Qt.AlignmentFlagFlagFlag.AlignTop | Qt.AlignmentFlagFlagFlag.AlignLeft)
