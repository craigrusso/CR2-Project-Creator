...
import datetime
import os
from PyQt6.QtWidgets import QFrame, QHBoxLayout, QLabel, QSizePolicy, QApplication, QMenu, QAction
...
class TemplateListItem(QFrame):
    ...
    def __init__(self, template, gallery=None, row_index=None):
        ...
        if not self.has_structure:
            ...
            self.warning_label.setAlignment(Qt.AlignmentFlagFlagFlag.AlignCenter)
        ...
        self.category_label.setAlignment(Qt.AlignmentFlagFlagFlag.AlignLeft | Qt.AlignmentFlagFlagFlag.AlignVCenter)
        ...
        self.created_date_label.setAlignment(Qt.AlignmentFlagFlagFlag.AlignLeft | Qt.AlignmentFlagFlagFlag.AlignVCenter)
        ...
        self.modified_date_label.setAlignment(Qt.AlignmentFlagFlagFlag.AlignLeft | Qt.AlignmentFlagFlagFlag.AlignVCenter)
