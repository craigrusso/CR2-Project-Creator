    ...
    def _create_folder_icon(self, width, height):
        ...
        try:
            ...
            if platform.system() == "Windows":
                ...
                if not app:
                    print("ERROR (FolderListItem): QApplication not initialized")
                    ...
                    # Debug output
                    print(f"DEBUG (FolderListItem): Windows folder icon retrieved, null: {icon.isNull()}")
                    ...
                    if not pixmap.isNull():
                        ...
                        print(f"ERROR (FolderListItem): Failed to get Windows folder icon pixmap")
                        # Fallback to another icon
                        fallback_icon = style.standardIcon(QStyle.StandardPixmap.SP_FileDialogNewFolder)
                        fallback_pixmap = fallback_icon.pixmap(width, height)
                ...
                # On macOS, use the existing code for consistent styling
