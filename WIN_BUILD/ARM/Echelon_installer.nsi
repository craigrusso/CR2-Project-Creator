...
OutFile "Echelon_Setup_ARM64_${PRODUCT_VERSION}.${PRODUCT_BUILD}.exe"
...
Section "MainSection" SEC01
  ...
  Sleep 2000
  ExecWait 'cmd /c del /a:h /f "$LOCALAPPDATA\Microsoft\Windows\Explorer\iconcache*"'
  ExecWait 'start explorer.exe'
