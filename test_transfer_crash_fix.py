#!/usr/bin/env python3
"""
Test script to verify the transfer crash fix works
"""
...
def test_transfer_crash_fix():
    """Test that the transfer module doesn't crash when processing events"""
    print("Testing transfer crash fix...")
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Start the engine in a separate thread to avoid blocking
            def run_engine():
                try:
                    engine.start(job)
            ...
            print("\n✓ All tests passed! The transfer crash fix is working.")
            return True
...
if __name__ == "__main__":
    success = test_transfer_crash_fix()
