...
class TreeIconTest(unittest.TestCase):
    ...
    def test_folder_icons_applied(self):
        ...
        self.assertEqual(self.root_item.data(0, Qt.UserRole), "folder")
        self.assertEqual(self.folder1.data(0, Qt.UserRole), "folder")
        self.assertEqual(self.folder2.data(0, Qt.UserRole), "folder")
    ...
    def test_file_icons_applied(self):
        ...
        self.assertEqual(self.file1.data(0, Qt.UserRole), "file")
        self.assertEqual(self.file2.data(0, Qt.UserRole), "file")
        self.assertEqual(self.file3.data(0, Qt.UserRole), "file")
